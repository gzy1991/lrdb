...
CKEDITOR.editorConfig = function( config )
{
	...
	config.toolbar_Full = [
	                       ...
	                       ['Table','HorizontalRule','Smiley','PageBreak','SpecialCharNew','Ck_Typesetting','Ck_Format'],
	                       '/',
	...
	config.extraPlugins = "dz_GenerationDir,ck_delDirInfo,dz_InsTitileDir,dz_Format,autoformat,dz_templateDesc,ck_DirTemplate,ck_PhotoLeftText,ck_PhotoText,ck_PhotoRightText,lar_upload,specialCharNew,ck_Typesetting,ck_Format";
