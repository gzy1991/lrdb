    ...
    var init = function(options){
        var settings = {
         ...
         //   server: getServer() +"/sword?SwordControllerName=sword-room-fileUpload",
            server: getServer() +"/sword?SwordControllerName=fileUploadController",
            chunked:true,
        ...
        if(this.saved){
            Util.confirm("是否从服务器中删除该附件?",function(){
                $.ajax({
                	...
                	url:getServer()+"/sword/fileUpload/delFile",
                    dataType: 'json',
                    data: {
    ...
    var InitUploader = function(Upload,settings) {
        ...
        uploader.on( 'uploadSuccess', function( file, response ) {
            ...
            var $a = $('<a></a>')
            	...
            	.attr('href',getServer()+'/sword?SwordControllerName=fileDownloadController&id='+file.swordFileId)
