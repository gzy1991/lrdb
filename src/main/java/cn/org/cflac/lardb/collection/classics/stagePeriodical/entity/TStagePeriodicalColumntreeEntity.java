...
/**
 * The persistent class for the t_stage_periodical_columntree database table.
 * 
 */
@Entity
@Table(name="t_stage_periodical_columntree")
@NamedQuery(name="TStagePeriodicalColumntreeEntity.findAll", query="SELECT t FROM TStagePeriodicalColumntreeEntity t")
public class TStagePeriodicalColumntreeEntity extends com.css.sword.core.kernel.base.dataElement.AbsPersistObject implements Serializable {
	...
	public TStagePeriodicalColumntreeEntity() {
	}
