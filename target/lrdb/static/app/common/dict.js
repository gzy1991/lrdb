...
//期刊增删该查地址--Start-------------------------------
	 ...
	 //获得分期刊LIST
	 URL_QUERYSTAGEPERIODICALINFOLIST_SERIVCE : stagePeriodicalServiceUrl + 'queryStagePeriodicalInfoList',
	 //分期刊_保存更新操作
	 URL_SAVEORUPDATESTAGEPERIODICAL_SERIVCE : stagePeriodicalServiceUrl + 'saveOrUpdateStagePeriodical',
	 //分期刊_新增时初始化页面信息
	 URL_QUERYSTAGEPERIODICALINFOBYID_SERIVCE : stagePeriodicalServiceUrl + 'queryStagePeriodicalInfoById',
	 //分期期刊_删除操作
	 URL_DELBATCHSTAGEPERIODICALINFOBYID_SERIVCE : stagePeriodicalServiceUrl + 'delBatchStagePeriodicalInfoById',
	 //分期期刊_编辑时初始化栏目
	 URL_QUERYSTAGEPERIODICALCOLUMNTREEBYID_SERIVCE : stagePeriodicalColumntreeServiceUrl + 'queryStagePeriodicalColumntreeById',
