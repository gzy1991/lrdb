...
define(['jquery','PDUtilDir/grid','PDUtilDir/util','LrdbCommonDir/record/record','PDUtilDir/inputSelect','LrdbCommonDir/dict',
	...
	function($,Grid,Util,Record,inputSelect,dict,uploader){
		...
		var iniencyclopediaEntity = function($scope){
			...
			$scope.encyclopedia.entity.createTime = '2015-10-10 10:10:10';
			$scope.encyclopedia.entity.lastmodifyTime = '2015-10-10 10:10:10';
			$scope.encyclopedia.entity.createUser = 'CSS';
			$scope.encyclopedia.entity.encyclopediaIndex = 'I';
			$scope.encyclopedia.entity.lastmodifyUser = 'I';
			$scope.encyclopedia.entity.operStatus = 'I';
			$scope.encyclopedia.entity.isSubmit = 'N';
			$scope.encyclopedia.entity.orgCode = 'CSSCSS';
