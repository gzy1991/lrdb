define(["PDUtilDir/slidebar", "PDUtilDir/loading", "jquery","css!PDUtilDir/css/util.css"],function(Slidebar, Loading){
    var util = {};
    /**
     * 简单模板引擎
     */
     ...
     * @param title
     */
    util.alert =function(message,title,callback){
        //允许第二个参数直接为回调函数
