...
<div id="navbar" class="navbar   navbar-default navbar-fixed-top">
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="navbar-header pull-left">
            <a target="_blank" href="http://chinass.github.io/example/static/index.html" class="navbar-brand">
                <small>
                    <c:choose>
			        	<c:when test="${pageInfo.systemName != null && pageInfo.systemName != '' }">  
							${pageInfo.systemName }
        ...
        <div class="navbar-buttons navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#">
                                        <img src="${ctx }/static/core/home/images/user.jpg" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle" id="pd_web_username_home">
                        您好……
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                        ...
                        <li>
                            <a href="#" id="pd_web_loginout_menuitem">
