...
INSERT INTO `org_certification` VALUES ('c8f1ba6c7cf842409aba43206e9f7442', '$s0$e0801$77jrffrqKY5/YbaxXCY32g==$UA4kWJWMx+kwVVYQ013YVq7H4oIfEqMrqtT/WmF31cM=', 'a18721153de246dfb9726864e327c473', '0', '0', '2015-11-09 00:57:23');
...
CREATE TABLE `pd_web_dictionary` (
  ...
  `dict_classification` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `pd_web_fileupload`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_web_fileupload
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_web_fileupload_chunk`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_web_fileupload_chunk
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_web_fileupload_config`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_web_fileupload_config
-- ----------------------------
...
INSERT INTO `pd_web_menu` VALUES ('58f2c451814e11e5b4be8c89a522e1b2', 'Service说明', '2', '71678a4a814d11e5b4be8c89a522e1b2', '0', null, '字典管理前端Service说明', 'static/core/examples/develop/dict/views/ServiceResume.html', '1', 'exam_DictServiceResume', 'exDictSampleCtrl', 'static/core/examples/develop/dict/dictCtrl', null);
INSERT INTO `pd_web_menu` VALUES ('58f85376814e11e5b4be8c89a522e1b2', 'DictAPI说明', '2', '71678a4a814d11e5b4be8c89a522e1b2', '0', null, '字典管理后端API说明', 'static/core/examples/develop/dict/views/DictAPI.html', '1', 'exam_DictAPIResume', 'exDictSampleCtrl', 'static/core/examples/develop/dict/dictCtrl', null);
...
INSERT INTO `pd_web_menu` VALUES ('71678a4a814d11e5b4be8c89a522e1b2', '字典管理', '1', 'b9b1bb999e434b65a3a989980d4a056c', '0', null, null, null, null, null, null, null, null);
...
INSERT INTO `pd_web_menu` VALUES ('8b380aaa0a4a4711982ab67e73ae1b74', 'treeDialog', '2', 'b9d4630e9e21419b97fc18a2272bb2e6', '1', null, null, 'static/core/examples/common.html', '1', 'treeDialog', 'treeDialogCtrl', 'static/core/examples/util/treeDialog/treeDialogCtrl', null);
...
INSERT INTO `pd_web_menu` VALUES ('a810f123344d446495e7526cb2343508', '网页播放器', '2', 'bd517830fd3e45fa80b641879d035986', '20', null, null, 'static/core/examples/common.html', '1', 'ckplayer', 'lab_ckplayer', 'static/core/examples/thirdParty/ckplayer/ckplayerCtrl', null);
...
-- ----------------------------
-- Table structure for `pd_wk_assign`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_wk_assign
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_wk_assign_day`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_wk_assign_day
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_wk_holiday`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_wk_holiday
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_wk_holiday_day`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_wk_holiday_day
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_wk_weekend`
-- ----------------------------
...
-- ----------------------------
-- Records of pd_wk_weekend
-- ----------------------------

-- ----------------------------
-- Table structure for `pd_wk_workhour`
-- ----------------------------
