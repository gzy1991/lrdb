					...
					'<div class="cs_cropper">' + 
						...
						'<div class="cs_cropper_wrap">' + 
							'<div class="cs_cropper_preview">' + 
								...
								/*
								'<label>宽<input id="text1" type="text" /></label>' +
								':' + 
								'<label>高<input id="text2" type="text" /></label>' +
								'<button id="btn1" type="button">设置</button>' +
								*/
							'</div>' + 
							'<div class="cs_cropper_view">' +
								'<img src="' + getServer() + '/static/modules/util/images/cropper2.jpg" alt="请选择图片" />' +
							'</div>' +
						'</div>' +
					'</div>';
			...
			var Cropper = (function(){
				...
				var isBase64Supported, 
 				...
 				$("#btn1").on("click", function() {
 					...
 					$image.cropper("setAspectRatio", scale);
 				})
