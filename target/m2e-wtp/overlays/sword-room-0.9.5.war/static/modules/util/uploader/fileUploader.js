define(["PDUtilDir/uploader/uploader",
	...
	var createFileUploaderBySettings=function(settings){
		...
		return createFileUploader(settings.parentDivId,type,mode,$.extend(options,settings.options));
	};
	...
	var createFileUploader=function(parentDivId,type,mode,options){
		...
		localOptions.server=localOptions.server ? localOptions.server : getServer() +"/swordOpera/fileUpload";
