...
define(["jquery","ZTree","css!ZTreeCss","css!PDUtilDir/css/inputSelect.css"],function($){
    ...
    Input.fn = Input.prototype = {
        ...
        initPanel : function(){
            ...
            this.$wrap.append(this.$panel).append(this.$content).append("<div class='clearAllValue'><i class='fa fa-trash-o'></i></div>");
            //设置placeholder
        ...
        hidePanel : function(){
            if(!!this.config.callback){
                var dataArr = this.getCurrentData();
                this.config.callback(dataArr.idArr,dataArr);
            }
