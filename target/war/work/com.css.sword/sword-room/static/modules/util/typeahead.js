                ...
                for (var i = data.length; --i>-1;) {
                    ...
                    if (!!dataFormat) {
                        ...
                        for(j=0, length=dataFormat.length;j<length;j++){
                            var value = data[i][dataFormat[j]["field"]];
                            formatHtml+="<span class="+dataFormat[j]["field"]+" style='width:"+(dataFormat[j]["width"]?dataFormat[j]["width"]:100/dataFormat.length)+"%'>"+(value?value:"")+"</span>";
                        }
                        cur = formatHtml;
                    } else {
